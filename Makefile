#############################################################################
# Makefile for building: VaosAndCollisionsWithoutGPUReuploading
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  VaosAndCollisionsWithoutGPUReuploading.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -o Makefile VaosAndCollisionsWithoutGPUReuploading.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = VaosAndCollisionsWithoutGPUReuploading1.0.0
DISTDIR = /home/yioannidis/QtStuff/Projects/VaosAndCollisionsWithoutGPUReuploading/obj/VaosAndCollisionsWithoutGPUReuploading1.0.0
LINK          = g++
...
DIST          = /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		VaosAndCollisionsWithoutGPUReuploading.pro include/Collisionstructure.h \
		include/NGLScene.h \
		include/vaotriangle.h src/Collisionstructure.cpp \
		src/main.cpp \
		src/NGLScene.cpp \
		src/vaotriangle.cpp
QMAKE_TARGET  = VaosAndCollisionsWithoutGPUReuploading
...
Makefile: VaosAndCollisionsWithoutGPUReuploading.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/qt/5.5/gcc_64/mkspecs/features/yacc.prf \
		/opt/qt/5.5/gcc_64/mkspecs/features/lex.prf \
		VaosAndCollisionsWithoutGPUReuploading.pro \
	...
	$(QMAKE) -o Makefile VaosAndCollisionsWithoutGPUReuploading.pro
